...
.. glossary::
 ...
 Parallel :term:`domain builds`
  ...
  NUMA-aware claims can be used to solve this problem and ensure that memory
 ...
 Domain builds
  ...
  run in parallel, it is referred to as parallel domain builds, which can
  benefit from NUMA-aware claims as the domain builders are competing for
 ...
 Parallel migrations
  ...
  Similar to :term:`boot storms`, only the domains are being migrated
