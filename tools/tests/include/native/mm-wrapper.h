 ...
 */
#ifndef TOOLS_TESTS_NATIVE_HARNESS_MM_WRAPPER_H
#define TOOLS_TESTS_NATIVE_HARNESS_MM_WRAPPER_H

#ifdef TEST_WRAP_XEN_INCLUDE_XEN_MM_H
#undef cf_check
...
/* Definitions for a minimum synthetic heap */
#undef  page_to_mfn
#define page_to_mfn(pg)  _mfn((pg) - &frame_table[0])
#undef  mfn_to_page
#define mfn_to_page(mfn) (&frame_table[mfn_x(mfn)])
#undef  mfn_valid
#define mfn_valid(mfn)   false

/* Virtual addresses for synthetic memory provided by the harness */
