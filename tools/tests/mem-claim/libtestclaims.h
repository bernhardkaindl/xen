...
/*
 * mem-claim-lib.h - Header file for the library for memory claim tests
 *
 * This header declares the interface for the library implemented in
 * mem-claim-lib.c, which provides helper functions for the memory claim tests.
 */
