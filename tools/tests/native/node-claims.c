...
static void test_claims_numa_install(int start_mfn)
{
    ...
    printf("node0=%u node1=%u avail0=%lu avail1=%lu\n",
        page_to_nid(test_get_node_page(node0, start_mfn)),
        page_to_nid(test_get_node_page(node1, start_mfn)),
        node_avail_pages[node0], node_avail_pages[node1]);
